package com.example.demo.hqgateway;


import com.example.demo.bean.security.RequestBase;
import com.example.demo.bean.security.ResponseBase;
import com.example.demo.utils.security.SecurityHelper;
import com.example.demo.utils.security.SecurityUtil;
import com.example.demo.utils.security.TypeUtil;
...
public class ApiSecurityTest1 {
    ...
    //日志
    private static Logger Log = (Logger) LoggerFactory.getLogger(ApiSecurityTest1.class);
