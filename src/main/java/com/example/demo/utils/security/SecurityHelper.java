...
import com.example.demo.bean.security.GatewayErrorCodeEnum;
import com.example.demo.bean.security.GatewayException;
import com.example.demo.bean.security.RequestBase;
import com.example.demo.bean.security.ResponseBase;
...
public class SecurityHelper {
    ...
    public static void encryptAndSign(RequestBase requestBase, String publicKey, String type, String rsaPrivateKey) throws GatewayException {
        try {
    ...
    public static String checkSignAndDecrypt(ResponseBase responseBase, String publicKey, String type, String rsaPrivateKey) throws GatewayException {
    ...
    private static String decrypt(Object content, String publicKey, String type, String rsaPrivateKey) throws Exception {
